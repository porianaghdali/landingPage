  ...
  return (
    <div className="grid gap-10">
      ...
      <div className="col-span-2">
          ...
          <p className="text-[16px] mb-6">پرسش‌‌های متداول به شما کمک می‌کند تا به راحتی به پاسخ سوالات پرتکرار دسترسی پیدا کنید و از خدمات حسنیکال بهره‌مند شوید. در صورت داشتن هرگونه پرسش بیشتر، تیم پشتیبانی ما همواره آماده پاسخگویی به شماست. </p>
